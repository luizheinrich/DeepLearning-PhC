...
% dipolo.m
%
% Model exported on Feb 14 2020, 21:11 by COMSOL 5.4.0.388.
...
model.modelPath(['C:\COMSOL_Deep_Learning\Dipolo']);

model.label('dipolo.mph');
...
model.param.set('H0', '0.861890e6[A/m]');
model.param.set('r1', '0.282');
model.param.set('y1', '7.618705117886264');
model.param.set('r2', '0.095');
model.param.set('y2', '9.29');
model.param.set('r3', '0.22');
model.param.group.create('par2');
model.param('par2').set('YF', '-0.6', 'Y Ferrite');
model.param('par2').set('RF', '-0.06', 'R Ferrite');
model.param('par2').set('YC', '0', 'Y Cilindros Duplos Inferiores');
model.param('par2').set('XC', '0', 'X Cilindros Duplos Inferiores');
model.param('par2').set('RC', '0', 'R Cilindros Duplos Inferiores');
model.param('par2').set('YCS', '0.5', 'Y Cilindro Superior');
model.param('par2').set('RCS', '-0.9', 'R Cilindro Superior');
model.param('par2').set('YCDS', '0', 'Y Cilindros Duplos Superiores');
model.param('par2').set('XCDS', '0', 'X Cilindros Duplos Superiores');
model.param('par2').set('RCDS', '0', 'R Cilindros Duplos Superiores');
model.param('par2').set('YCDDS', '0', 'Y');
model.param('par2').set('XCDDS', '0', 'X');
model.param('par2').set('RCDDS', '0', 'R');
model.param('par2').set('YCDDI', '0', 'Y');
model.param('par2').set('XCDDI', '0', 'X');
model.param('par2').set('RCDDI', '0', 'R');
model.param('par2').set('YCDDI1', '-0.25', 'Y Cilindros Duplos Sub Inferior');
model.param('par2').set('XCDDI1', '0.25', 'X Cilindros Duplos Sub Inferior');
model.param('par2').set('RCDDI1', '0.5', 'R Cilindros Duplos Sub Inferior');
...
model.component('mod1').geom('geom1').feature('c2').set('pos', {'5*a' 'y1*a*(1+YF*0.01)'});
model.component('mod1').geom('geom1').feature('c2').set('r', 'r1*a*(1+RF*0.01)');
model.component('mod1').geom('geom1').create('c3', 'Circle');
model.component('mod1').geom('geom1').feature('c3').set('pos', {'5*a' 'y2*a*(1+YCS*0.01)'});
...
model.component('mod1').material('mat4').selection.set([2 74 85 99 100 112 123]);
